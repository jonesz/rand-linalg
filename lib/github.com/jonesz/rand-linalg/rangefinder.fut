...
module mk_rangefinder (D: sketch_right_oracle) (QR: { val qr [m][n] : [m][n]D.t -> ([m][n]D.t, [n][n]D.t) }): {
	module sk: sketch_right_oracle
	val rangefinder [m][n] : sk.dist.engine.k -> (l: i64) -> ([n]t -> [m]t) -> [m][l]D.t
} = {
	module sk = D
	def rangefinder [m][n] seed l oracle =
